...
const index = () => {
    return (
        <div>
            <TopHeader />
            <nav className="navbar fixed right-0 left-0 top-0 lg:top-[44.5px] px-5 lg:px-24 transition-all duration-500 ease shadow-lg shadow-gray-200/20 bg-white border-gray-200 dark:bg-neutral-800 z-40 dark:shadow-neutral-900"
                id="navbar">
                                                ...
                                                <div className="border rounded border-gray-50 dark:border-neutral-600"
                                                    ...
                                                    <div className="h-60" data-simplebar>
                                                        <div>
                                                            ...
                                                            <a href="#!">
                                                                <div
                                                                    className="flex items-center p-4 hover:bg-gray-50/30 dark:hover:bg-neutral-600/50">
                                                                    <div className="flex-shrink-0 ltr:mr-3 rtl:ml-3">
                                                                        <img src="assets/images/user/img-01.jpg"
                                                                            className="w-10 h-10 rounded-full" alt="user-pic" />
                                                                    </div>
                                                                    <div className="flex-grow">
                                                                        <h6 className="mb-1 text-sm text-gray-700 dark:text-gray-300">Kevin
                                                                            Stewart</h6>
                                                                        <div className="text-gray-600 text-13 dark:text-gray-300">
                                                                            <p className="mb-0"><i
                                                                                className="mdi mdi-clock-outline dark:text-gray-300"></i>
                                                            ...
                                                            <a href="#!">
                                                                <div
                                                                    ...
                                                                    <div className="flex-grow">
                                                                        <h6 className="mb-1 text-sm text-gray-700 dark:text-gray-300">
                                                            ...
                                                            <a href="#!">
                                                                <div
                                                                    ...
                                                                    <div className="flex-grow">
                                                                        <h6 className="mb-1 text-sm text-gray-700 dark:text-gray-300">Salena
                                                                            Layfield</h6>
                                                                        <div className="text-gray-600 text-13 dark:text-gray-300">
                                                                            <p className="mb-0"><i
                                                                                className="mdi mdi-clock-outline dark:text-gray-300"></i>
                                    ...
                                    <div>
                                        <div className="relative dropdown ltr:mr-4 rtl:ml-4">
                                            <button type="button" className="flex items-center px-4 py-5 dropdown-toggle"
                                                ...
                                                <span className="hidden fw-medium xl:block dark:text-gray-50">Shawn L.</span>
                                            </button>
