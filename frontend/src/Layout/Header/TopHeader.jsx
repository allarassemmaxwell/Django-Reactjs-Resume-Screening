...
const TopHeader = () => {
    ...
    return (
        <div>
            <div id="navbar"  className="hidden px-5 mx-auto border-gray-200 container-fluid lg:px-24 bg-gray-50 md:block dark:bg-neutral-600">
                    ...
                    <div className="col-span-5 ltr:ml-auto rtl:mr-auto">
                        <ul className="flex items-center gap-4">
                            <li>
                                ...
                                {user ?
                                    <a onClick={logoutUser} className="py-3 font-medium text-gray-800 text-13 dark:text-gray-50"
                                    data-tw-toggle="modal" data-tw-target="#modal-id_form"><i
                                        className="uil uil-lock ltr:mr-1 rtl:ml-1"></i>Sign Out</a>:
                                    <a href="/login" className="py-3 font-medium text-gray-800 text-13 dark:text-gray-50"
                                    data-tw-toggle="modal" data-tw-target="#modal-id_form"><i
